                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">
                            {projectConfig?.requires_cards !== false
                                ...
                                : `المشروع لا يتطلب بطاقات — العدد الافتراضي: ${projectConfig?.cards_per_beneficiary || 1}`}
                        </p>
                    </div>
                </div>
                                        ...
                                        onClick={() => {
                                            if (beni.status === 'pending') {
                                                ...
                                                if (projectConfig?.requires_cards !== false) {
                                                    ...
                                                    if (count > 50) { toast.error('تحذير: عدد بطاقات خاطئ بالإكسل — تم تقليصه لـ 50'); count = 50; }
